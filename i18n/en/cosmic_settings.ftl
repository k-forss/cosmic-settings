...
calendar = Calendar
calendar-desc = Manage calendar sources, sync settings, and display preferences
calendar-sources = Calendar Sources
calendar-no-sources = No calendar sources configured
calendar-add-source = Add Source
calendar-edit-source = Edit Source
calendar-source-name = Name
calendar-source-type = Type
...
calendar-source-auth = Authentication
calendar-source-auth-none = None
calendar-source-auth-basic = Basic
calendar-source-auth-bearer = Bearer Token
calendar-source-auth-oidc = OIDC
calendar-source-username = Username
calendar-source-password = Password
calendar-source-token = Token
calendar-source-oidc-issuer = Issuer URL
calendar-source-oidc-client-id = Client ID
calendar-source-oidc-client-secret = Client Secret
calendar-source-oidc-client-secret-hint = Leave empty for public OIDC clients
calendar-source-oidc-scopes = Scopes
calendar-source-oidc-callback-url = Callback URL
calendar-source-oidc-callback-pattern = http://127.0.0.1:*/callback (port assigned at login)
calendar-source-oidc-login = Log In with OIDC
calendar-source-oidc-reauth = Re-authenticate
calendar-auth-expired-reauth = Authentication expired, re-authenticating…
calendar-form-oidc-login-first = Please log in with OIDC first
calendar-source-ca-cert = CA Certificate Path
calendar-browse = Browse
calendar-source-color = Color
calendar-save = Save
calendar-cancel = Cancel
calendar-discover = Discover Calendars
calendar-discovering = Discovering…
calendar-discover-error = Failed to discover calendars
calendar-sync-settings = Sync Settings
calendar-sync-interval = Sync Interval (minutes)
calendar-upcoming-count = Upcoming Events Count
calendar-encryption-mode = Cache Encryption
calendar-encryption-none = None
calendar-encryption-auto = Auto
calendar-encryption-manual = Manual
calendar-validation-name-required = Name is required
calendar-validation-url-invalid = Invalid URL
